		...
		stage('Deploy') 
		{
			...
			steps 
			{
				...
				script
				{
					...
					transfers: [sshTransfer(cleanRemote: false, excludes: '', execCommand: 'ansible-playbook /etc/ansible/copywarfile.yml -e current_project_version="${MY_BUILD_VERSION}"-SNAPSHOT', 
